...
function inti_scripts()
{
	...
	wp_register_style( 'main', 'http://style.codeforamerica.org/3/style/css/main.css' );
	wp_register_style( 'layout', 'http://style.codeforamerica.org/3/style/css/layout.css', array(), false, 'all and (min-width: 40em)' );
	wp_register_style( 'prism', 'http://style.codeforamerica.org/3/style/css/prism.css' );
