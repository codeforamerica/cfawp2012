...
get_header(); ?>
  ...
  <div class="wrap-b">
      ...
      <div id="featured" style="width: 935px; margin: 0 auto; height: 290px; background: url() no-repeat bottom;padding: 20px 0px;">
          ...
          <h1 style="font-family: 'Oswald', Helvetica; text-transform: uppercase; color: black; font-size: 40px; letter-spacing: -.05em; text-align: left;">The CfA Fellowship</h1>
          		    ...
          		    <a href="/2013-partners" data-bitly-type="bitly_hover_card" style=""><img src="http://codeforamerica.org/wp-content/uploads/2012/10/2013.png" align="left"></a>
          		  </div>
          		  <div id="map" style="width: 500px; height: 260px; float: right; padding-top: 10px;">
          		      <iframe src="http://player.vimeo.com/video/53640839" width="500" height="260" frameborder="0" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen=""></iframe>
          		  </div>
