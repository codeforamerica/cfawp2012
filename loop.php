...
<?php /* How to display all other posts. */ ?>
	...
	<?php else : ?>
			...
			<div style="float: left; margin-bottom: 30px;"><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'twentyten' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_post_thumbnail('thumbnail'); ?></div>	<div class="post" style="<?php 
					...
					<?php the_excerpt(); ?>
		            <ul>
		<li>Share: <a href="#" class="like-btn" id="mail-b">E-mail</a> <a href="#" class="like-btn" id="rss-b">RSS</a> <a href="#" class="like-btn" id="fb-b" class="st_sharethis_custom">Facebook</a> <a href="#" class="like-btn" id="tw-b">Twitter</a></li>
